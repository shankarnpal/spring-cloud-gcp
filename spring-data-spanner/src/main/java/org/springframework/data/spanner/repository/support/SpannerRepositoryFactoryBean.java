...
public class SpannerRepositoryFactoryBean<T extends Repository<S, ID>, S, ID extends Serializable>
	...
	protected RepositoryFactorySupport createRepositoryFactory() {
		return new SpannerRepositoryFactory(this.operations);
	}
	...
	public void afterPropertiesSet() {
		...
		Assert.notNull(this.operations, "SpannerTemplate must not be null!");

		if (this.mappingContext == null) {
			setMappingContext(this.operations.getMappingContext());
		}
	}
}
