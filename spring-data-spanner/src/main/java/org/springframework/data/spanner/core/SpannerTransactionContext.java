...
public class SpannerTransactionContext {
	...
	public SpannerTransactionContext(TransactionContext transactionContext,
			SpannerReadContextTemplate readContextTemplate,
	...
	public <T> List<T> find(Class<T> entityClass, Statement statement,
		...
		return this.readContextTemplate.find(this.transactionContext, entityClass,
				statement, options);
	}
	...
	public void update(Object object, String... properties) {
		Mutation mutation = this.mutationFactory.update(object, properties);
		this.transactionContext.buffer(mutation);
	}
